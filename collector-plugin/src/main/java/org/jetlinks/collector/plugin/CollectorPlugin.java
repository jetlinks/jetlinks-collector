...
/**
 * 数据采集插件,继承此抽象类,平台将调用{@link CollectorPlugin#createProviders()}方法注册数采提供商到平台
 *
 * @author zhouhao
 * @since 1.0.0
 */
public abstract class CollectorPlugin extends AbstractPlugin {
    ...
    public static final PluginType TYPE = new PluginType() {
        ...
        public String getName() {
            return LocaleUtils.resolveMessage("message.plugin.collector.name","数据采集v2.0");
        }
    };

    public CollectorPlugin(String id, PluginContext context) {
        super(id, context);
    }
